...
public class SteerableMissileLauncher extends MissileLauncher implements ISteerable{
	...
	private PlayerShip mountedOn;
	public SteerableMissileLauncher(double x, double y, int speed, int heading, int r, int g, int b, int launcherSize, int size, PlayerShip mountedOn) {
		super(x, y, speed, heading, r, g, b, launcherSize, size);
		this.mountedOn = mountedOn;
		this.speed = speed;
		this.heading = heading;
		this.x = x;
		this.y = y;
		this.loc = mountedOn.getLoc();
